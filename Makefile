...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/06/01 15:49:58 by rsheasby          #+#    #+#              #
#    Updated: 2017/06/11 16:10:01 by rsheasby         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_isdigit.c ft_islower.c ft_isprint.c ft_isupper.c ft_itoa.c ft_memalloc.c \
